...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupal:password@db:3306/pontevedra?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.files']['url'] = 'http://civi.pontevedra.emergyalabs.com//sites/default/files/civicrm';
$civicrm_paths['civicrm.files']['path'] = '/opt/drupal/web/web/sites/default/files/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://drupal:password@db:3306/pontevedra?new_link=true');
  }
}
...
$civicrm_root = '/opt/drupal/web/vendor/civicrm/civicrm-core/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/opt/drupal/web/web/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://civi.pontevedra.emergyalabs.com');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'rwBk1mZVN7oQW4XsKUnLo8Z4wzu1N3HYfuxv6YirAw');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:NXv1oPH45ptuVyOBOSbkjHDbwAn9Hf0suxKpaN5dggLJlz48uQ');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:E6g1BXNxKc37m9s5IzPfKcjeZ7hszmG69CFBF6Ct8QuJoBcQv7iw');
...
// define( 'CIVICRM_MAIL_LOG', '/opt/drupal/web/web/sites/default/files/civicrm/templates_c/mail.log');
// }
